...
namespace DealerManagementSystem.Utils //TODO change namespace
{
    public  class NTContext : IDisposable
    {
        ...
        public NTContext(string connection_string)
        {
            this.ConnectionString = connection_string;
            this.Timeout = 1200;
        }
        public NTContext()
            : this(ConfigurationManager.ConnectionStrings["ComtekConnection"].ConnectionString) //TODO change connection string name in .config file
        { }
