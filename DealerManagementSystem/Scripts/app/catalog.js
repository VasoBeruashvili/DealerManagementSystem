var app = angular.module('catalog-app', []);

var contragentShoppingCartAmountSum = $('#shoppingCart').text();

app.controller('catalog-ctrl', function ($scope, $http) {
    $('#overlay').hide();

    getProductsByGroupId = function (groupId) {
        $('#overlay').show();
        $http.post('/home/getProductsByGroupId', { groupId: groupId }).then(function (resp) {            
